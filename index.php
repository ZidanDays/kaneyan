...
<head>
  ...
  <link rel="shortcut icon" href="logo minsel.png">
  ...
  <title>Web Profile Desa Kaneyan Pintar</title>
</head>
<body>
    ...
    <div class="container">
      ...
      <nav class="site-nav">
        <div class="logo">
          <a href="index.html" class="text-white">Desa Kaneyan<span class="text-black">.</span></a>
        </div>
          ...
          <div class="col-12 col-sm-12 col-lg-12 site-navigation text-right">
            <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu">
              ...
              <li class="has-children">
                <a href="#">Pages</a>
                <ul class="dropdown">
                  <li><a href="strukturorg.html">Struktur Organisasi Desa</a></li>
    ...
    <div class="hero-slant overlay" data-stellar-background-ratio="0.5" style="background-image: url('images/kaneyan3.jpg')">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center"  data-aos="fade-up">
            <h2 class="heading font-weight-bold mb-3">Tentang Kami</h2>
          </div>
        </div>
